               ...
               <div class="card-body">
                  <form action="/mahasiswa" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror " name="nama" id="nama" aria-describedby="Nama" placeholder="Nama" value="{{ old("nama") }}">
                        @error('nama')
                     ...
                     <div class="form-group">
                        ...
                        @enderror" name="nrp" id="nrp" placeholder="NRP" value="{{ old("nrp") }}">
                        @error('nrp')
                           <small id="" class="invalid-feedback">{{ $message }}</small>
                        @enderror
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        @enderror" name="jurusan" id="jurusan" placeholder="Jurusan" value="{{ old("jurusan") }}">
                        @error('jurusan')
                           <small id="" class="invalid-feedback">{{ $message }}</small>
                        @enderror
                     </div>
